...
public class NotificationHelper {
     ...
     *
     * @instances is a static map for this class that holds every NotificationHelper instance. you can access desired instance by using instances.get(CHANNEL_ID)
     */
